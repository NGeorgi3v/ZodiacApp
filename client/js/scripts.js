...
let getData = () => {
    let userSearch = document.querySelector("#user-search").value.toLowerCase();
    zodiacs.forEach(zodiac => {
        if(userSearch === zodiac.name.toLowerCase()){
            document.querySelector("#name").innerHTML = zodiac.name;
            document.querySelector("#date").innerHTML = zodiac.month;
            document.querySelector("#text-result").innerHTML = zodiac.description;
            document.querySelector("#img").setAttribute("src", zodiac.image);
        }
    });
};